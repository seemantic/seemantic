...
# TODO MANAGE TOO BUG DOCUMENT TOO LONG FOR LATE_CHUNKING
    async def embed_document(self, document: ParsedDocument, chunks: list[Chunk]) -> list[EmbeddedChunk]:
        ...
        for group in chunk_groups:
            ...
            embedded_chunks = [EmbeddedChunk(chunk=chunk, embedding=embedding) for chunk, embedding in zip(group, embeddings, strict=True)]
