...
class Chunker:
    ...
    def _chunk_with_size(self, start_index: int, end_index: int) -> list[Chunk]:
    ...
    def chunk(self, doc: ParsedDocument) -> list[Chunk]:
        ...
        md_content = doc.markdown_content
